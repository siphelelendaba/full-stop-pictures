...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Full Stop Pictures is a female-owned production company creating cinematic African stories for global audiences." },
      { name: "author", content: "Full Stop Pictures" },
      { property: "og:title", content: "Full Stop Pictures — Authentic African Storytelling" },
      { property: "og:description", content: "Full Stop Pictures is a female-owned production company creating cinematic African stories for global audiences." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Full Stop Pictures — Authentic African Storytelling" },
      { name: "twitter:description", content: "Full Stop Pictures is a female-owned production company creating cinematic African stories for global audiences." },
